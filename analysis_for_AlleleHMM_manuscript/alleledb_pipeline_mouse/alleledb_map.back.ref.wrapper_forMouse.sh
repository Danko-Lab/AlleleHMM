...
liftOver <(cat ${BOWTIEFILE}.[1-9]_${MATPATERNAL}.bed ${BOWTIEFILE}.1[0-9]_${MATPATERNAL}.bed ${BOWTIEFILE}.[XY]_${MATPATERNAL}.bed) ${CHAINFILE} ${BOWTIEFILE}.${MATPATERNAL}.map2ref.bed ${BOWTIEFILE}.${MATPATERNAL}.unmap2ref.log

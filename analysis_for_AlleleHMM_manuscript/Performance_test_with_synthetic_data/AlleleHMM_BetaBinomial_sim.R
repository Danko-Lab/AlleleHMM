...
m=Get_table_from_simulation(e_test_out)
write.table(m, file = "exp_OD0.25_l40_sensitivity_and_precision_iter1K.txt", quote = F, sep = "\t",row.names = F)
...
m=Get_table_from_simulation(test)
write.table(m, file = "MatP_SMS_OD0.25_e10_l40_sensitivity_and_precision_iter1K.txt", quote = F, sep = "\t",row.names = F)
